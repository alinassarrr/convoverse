...
export function MessageInput({ conversation, onMessageSent, onOptimisticMessage }: MessageInputProps) {
    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message.includes("n8n")) {
          ...
          errorMessage = "You're not authorized to send messages. Please reconnect your Slack integration.";
        } else {
      ...
      <div className="flex gap-2 items-end">
        <div className="flex-1">
          <Textarea
            ...
            placeholder={`Message ${conversation.is_im ? conversation.sender.display_name : `#${conversation.name}`}...`}
